...
function AmericanGameForm(btnText, handleSubmit, projectData, serviceData){
    ...
    function handleOnSelectFormat(e){
        const formatType = formatTypes.filter(
            format => format.id === e.target.options[e.target.selectedIndex].value
        );
...
export default AmericanGameForm;