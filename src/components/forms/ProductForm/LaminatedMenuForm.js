...
function LaminatedMenuForm(btnText, handleSubmit, projectData, serviceData){
    ...
    const [ennoblementTypes, setEnnoblementTypes] = useState([]);
...
export default LaminatedMenuForm;